...
/**
 * 数据库表t_data_blood_oxygen 的Controller层测试类
 * @author zimu
 * @date 2016-11-05 15:26:21 中国标准时间
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration("classpath:spring-*.xml")
public class DataBloodOxygenControllerTester {

	@Autowired
	DataBloodOxygenController controller;
	
	@Test
	public void add() throws Exception{
		DataBloodOxygen model = new DataBloodOxygen();
