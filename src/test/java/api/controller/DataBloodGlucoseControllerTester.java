...
/**
 * 数据库表t_data_blood_glucose 的Controller层测试类
 * @author zimu
 * @date 2016-11-05 15:26:21 中国标准时间
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration("classpath:spring-*.xml")
public class DataBloodGlucoseControllerTester {

	@Autowired
	DataBloodGlucoseController controller;
	
	@Test
	public void add() throws Exception{
		DataBloodGlucose model = new DataBloodGlucose();
