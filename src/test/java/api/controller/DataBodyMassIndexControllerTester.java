...
/**
 * 数据库表t_data_body_mass_index 的Controller层测试类
 * @author zimu
 * @date 2016-11-05 15:26:21 中国标准时间
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration("classpath:spring-*.xml")
public class DataBodyMassIndexControllerTester {

	@Autowired
	DataBodyMassIndexController controller;
	
	@Test
	public void add() throws Exception{
		DataBodyMassIndex model = new DataBodyMassIndex();
