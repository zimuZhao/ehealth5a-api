...
/**
 * 数据库表t_data_body_mass_index的Dao接口
 * @author zimu
 * @date 2016-11-05 15:26:19 中国标准时间
 */
public interface DataBodyMassIndexDao extends BaseDao<DataBodyMassIndex>{
	 ...
	 * @throws Exception
	 */
	DataBodyMassIndex findByRecentTime(Object userID) throws Exception;
