...
/**
 * 数据库表t_data_hemoglobin的Dao接口
 * @author zimu
 * @date 2016-11-05 15:26:19 中国标准时间
 */
public interface DataHemoglobinDao extends BaseDao<DataHemoglobin>{
	 ...
	 * @throws Exception
	 */
	DataHemoglobin findByRecentTime(Object userID) throws Exception;
