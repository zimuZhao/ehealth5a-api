...
/**
 * 数据库表t_data_blood_oxygen的Dao接口
 * @author zimu
 * @date 2016-11-05 15:26:19 中国标准时间
 */
public interface DataBloodOxygenDao extends BaseDao<DataBloodOxygen>{
	 ...
	 * @return 数据对象 or null
	 */
	DataBloodOxygen findById(Object id) throws Exception;
	/**
	 * 获取全部数据
	 * @return 全部所有数据
	 */
	List<DataBloodOxygen> findAll() throws Exception;
	/**
	 * 分页查询数据
	 * @param limit 分页最大值
	 * @param start 开始编号
	 * @return 分页列表数据
	 */
	List<DataBloodOxygen> findByPage(int limit,int start) throws Exception;
	/**
	 * 根据用户ID获取所有记录
	 * @param userID
	 * @return
	 * @throws Exception
	 */
	List<DataBloodOxygen> findByUserID(Object userID) throws Exception;
	/**
	 * 根据用户ID获取最新记录
	 * @param userID
	 * @return
	 * @throws Exception
	 */
	DataBloodOxygen findByRecentTime(Object userID) throws Exception;
