...
/**
 * 数据库表t_data_temperature 的Controller层实现
 * @author zimu
 * @date 2016-11-05 15:26:19 中国标准时间
 */
@RestController
@Intent("数据库表t_data_temperature")
@RequestMapping("datatemperature")
public class DataTemperatureController extends GeneralController<DataTemperature>{

	@Autowired
	DataTemperatureService service;
	...
	@Override
	@RequestMapping("add")
	public Object add(@RequestBody DataTemperature model) throws Exception {
	...
	public Object update(@RequestBody DataTemperature model) throws Exception {
