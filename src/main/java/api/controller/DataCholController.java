...
/**
 * 数据库表t_data_chol 的Controller层实现
 * @author zimu
 * @date 2016-11-05 15:26:19 中国标准时间
 */
@RestController
@Intent("数据库表t_data_chol")
@RequestMapping("datachol")
public class DataCholController extends GeneralController<DataChol>{

	@Autowired
	DataCholService service;
	...
	@Override
	@RequestMapping("add")
	public Object add(@RequestBody DataChol model) throws Exception {
	...
	public Object update(@RequestBody DataChol model) throws Exception {
