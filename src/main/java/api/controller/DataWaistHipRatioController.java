...
/**
 * 数据库表t_data_waist_hip_ratio 的Controller层实现
 * @author zimu
 * @date 2016-11-05 15:26:19 中国标准时间
 */
@RestController
@Intent("数据库表t_data_waist_hip_ratio")
@RequestMapping("datawaisthipratio")
public class DataWaistHipRatioController extends GeneralController<DataWaistHipRatio>{
	...
	@Override
	@RequestMapping("add")
	public Object add(@RequestBody DataWaistHipRatio model) throws Exception {
	...
	public Object update(@RequestBody DataWaistHipRatio model) throws Exception {
