...
/**
 * 数据库表t_data_hemoglobin 的Controller层实现
 * @author zimu
 * @date 2016-11-05 15:26:19 中国标准时间
 */
@RestController
@Intent("数据库表t_data_hemoglobin")
@RequestMapping("datahemoglobin")
public class DataHemoglobinController extends GeneralController<DataHemoglobin>{

	@Autowired
	DataHemoglobinService service;
	...
	@Override
	@RequestMapping("add")
	public Object add(@RequestBody DataHemoglobin model) throws Exception {
	...
	public Object update(@RequestBody DataHemoglobin model) throws Exception {
