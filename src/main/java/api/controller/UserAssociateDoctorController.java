...
/**
 * 数据库表t_user_associate_doctor 的Controller层实现
 * @author zimu
 * @date 2016-12-30 21:15:48 中国标准时间
 */
@RestController
@Intent("数据库表t_user_associate_doctor")
@RequestMapping("userassociatedoctor")
public class UserAssociateDoctorController extends GeneralController<UserAssociateDoctor> {

	@Autowired
	UserAssociateDoctorService service;
	...
	@Override
	@RequestMapping("add")
	public Object add(@RequestBody UserAssociateDoctor model) throws Exception {
	...
	public Object update(@RequestBody UserAssociateDoctor model) throws Exception {
