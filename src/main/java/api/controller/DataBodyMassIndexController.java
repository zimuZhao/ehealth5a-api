...
/**
 * 数据库表t_data_body_mass_index 的Controller层实现
 * @author zimu
 * @date 2016-11-05 15:26:19 中国标准时间
 */
@RestController
@Intent("数据库表t_data_body_mass_index")
@RequestMapping("databodymassindex")
public class DataBodyMassIndexController extends GeneralController<DataBodyMassIndex>{

	@Autowired
	DataBodyMassIndexService service;
	...
	@Override
	@RequestMapping("add")
	public Object add(@RequestBody DataBodyMassIndex model) throws Exception {
	...
	public Object update(@RequestBody DataBodyMassIndex model) throws Exception {
