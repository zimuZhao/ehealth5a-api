...
/**
 * 数据库表t_data_blood_pressure 的Controller层实现
 * @author zimu
 * @date 2016-11-05 15:26:19 中国标准时间
 */
@RestController
@Intent("数据库表t_data_blood_pressure")
@RequestMapping("databloodpressure")
public class DataBloodPressureController extends GeneralController<DataBloodPressure>{

	@Autowired
	DataBloodPressureService service;
	...
	@Override
	@RequestMapping("add")
	public Object add(@RequestBody DataBloodPressure model) throws Exception {
	...
	public Object update(@RequestBody DataBloodPressure model) throws Exception {
