...
/**
 * 数据库表t_user_associate_family 的Controller层实现
 * @author zimu
 * @date 2016-12-30 21:15:48 中国标准时间
 */
@RestController
@Intent("数据库表t_user_associate_family")
@RequestMapping("userassociatefamily")
public class UserAssociateFamilyController extends GeneralController<UserAssociateFamily> {

	@Autowired
	UserAssociateFamilyService service;
	...
	@Override
	@RequestMapping("add")
	public Object add(@RequestBody UserAssociateFamily model) throws Exception {
	...
	public Object update(@RequestBody UserAssociateFamily model) throws Exception {
