...
/**
 * 数据库表t_data_blood_glucose 的Controller层实现
 *
 * @author zimu
 * @date 2016-11-05 15:26:19 中国标准时间
 */
@RestController
@Intent("数据库表t_data_blood_glucose")
@RequestMapping("databloodglucose")
public class DataBloodGlucoseController extends GeneralController<DataBloodGlucose> {

    @Autowired
    DataBloodGlucoseService service;
    ...
    @Override
    @RequestMapping("add")
    public Object add(@RequestBody DataBloodGlucose model) throws Exception {
    ...
    public Object update(@RequestBody DataBloodGlucose model) throws Exception {
