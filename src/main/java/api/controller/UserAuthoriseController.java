...
/**
 * 数据库表t_user_authorise 的Controller层实现
 * @author zimu
 * @date 2016-11-05 15:26:19 中国标准时间
 */
@RestController
@Intent("数据库表t_user_authorise")
@RequestMapping("userauthorise")
public class UserAuthoriseController extends GeneralController<UserAuthorise>{
	...
	@Override
	@RequestMapping("add")
	public Object add(@RequestBody UserAuthorise model) throws Exception {
	...
	public Object update(@RequestBody UserAuthorise model) throws Exception {
